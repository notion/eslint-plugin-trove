...
`,
    errors: [{
      message: 'Cannot reach into top-level package for "notion-modules/thread/message"',
      line: 1,
      column: 1,
...
`,
    errors: [{
      message: 'Cannot reach into top-level package for "notion-modules/thread/component/some-component.js"',
      line: 2,
      column: 3,
      type: 'ImportDeclaration',
    }],
